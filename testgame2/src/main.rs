...
fn main() {
    ...
    // we have all the pixel data stored in the t_map_storage, it should be a resource soon 
    ...
    // println!("Rendermap has a total of {:?} rendergrids",render_map.clone().unwrap().grids.len());

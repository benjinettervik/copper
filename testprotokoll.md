...
## Förberedelser
Om du inte är bekant med Entity Component System, vänligen läs ECS.md. Sedan läs README.md
...
**Uppgift: ** definiera en "HealthComponent" som innehåller en variabel för befintlig HP.

## Steg 2
Nu har du en component och vill skapa ett system för att skapa dessa 10 entiteter, samt 

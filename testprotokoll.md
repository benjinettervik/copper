...
## Steg 3
Nu har du dina entities med PositionComponent. För att vidare testa Copper vill du nu göra ett till system som flyttar på varje entity vid varje Update (frame). Entiteterna kan flyttas på valfritt sätt.

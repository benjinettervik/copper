...
mod resources_basic_type_tests {
    ...
    pub fn hash_map_example() {
        ...
        // hashmap insert
        resources.insert(TypeId::of::<TestRenderer>(), Box::new(mock_resources));
        // hashmap get
...
mod resources_pre_refactor_tests {
    ...
    use crate::resources_pre_refactor_tests::renderer::test_components_renderer::{
        TextureAsset, TextureHandle,
    };
    use crate::resources_pre_refactor_tests::resource::camera::Camera2D;
    use crate::resources_pre_refactor_tests::resource::{RenderCommand, RenderQueue};
    use ::copper::*;
    use copper::engine::Engine;
    use copper::engine::world::*;
    use std::any::{Any, TypeId};

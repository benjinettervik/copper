...
mod scheduler_test {
    ...
    use copper::renderer::render_sys::{
        GridHandle, GridRenderMeta, GridRenderSys, GridStorage, NewRenderSys, RenderSys,
        TMapHandle, TileMap, TileMapStorage,
    };
    use copper::resource::camera::*;
    use copper::resource::{RenderLayer, Resources, TM_Handle, TextureMap};
    use copper::resource::{
        convert_texture, extract_layer_data2, extract_tileset, json_to_rendermap,
    };
    ...
    pub struct WorldRefact {
        ...
        component_storages:
            HashMap<ComponentId, RwLock<HashMap<EntityId, Box<dyn Any + Send + Sync>>>>,
    }
